...
function generateIconIndex() {
  const iconsDir = path.join(__dirname, '../Azure_Public_Service_Icons/Icons');
  const outputFile = path.join(__dirname, '../icon-viewer/src/iconIndex.json');
  ...
  const categoriesFile = path.join(__dirname, '../icon-viewer/src/categories.json');
